...
Преобразуйте следующие значения к строке или числу 
или логическому значению и выведите в консоль результат. Изучите результаты. */

/* to string */
console.log('17 to string is ' + String(17)); //результат: '17'
...
console.log("'' to boolean is " + Boolean('')); // false, пустая строка является ложным значением

console.log("' ' to boolean is " + Boolean(' ')); // true, непустая строка

console.log('17 to boolean is ' + Boolean(17)); // true

console.log("'Hello' to boolean is " + Boolean('Hello')); // true, все непустые строки являются истинными